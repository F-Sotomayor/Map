...
exports.default = _default;
},{"firebase/app":"node_modules/firebase/app/dist/index.cjs.js","firebase/auth":"node_modules/firebase/auth/dist/index.esm.js","firebase/firestore":"node_modules/firebase/firestore/dist/index.esm.js"}],"api.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  auth: {
    signIn: function signIn() {
      return _firebase.auth.signInWithPopup(_firebase.providers.google);
    },
  ...
  registries: {
    ...
    list: function list() {
      return _firebase.database.collection("registries").get().then(function (snapshot) {
...
exports.default = _default;
},{"./firebase":"firebase.js"}],"marker.js":[function(require,module,exports) {
"use strict";
...
var infoWindow = new google.maps.InfoWindow(); // Adds a marker to the map.
...
},{"./map":"map.js"}],"map.js":[function(require,module,exports) {
"use strict";
...
_api.default.auth.onChange(function (_user) {
  if (!_user) {
...
document.getElementById("logout").addEventListener("click", function () {
  _api.default.auth.signOut();
});

_api.default.registries.list().then(function (registries) {
  registries.forEach(function (registry) {
    (0, _marker.add)({
      map: map,
      category: registry.category,
      location: new google.maps.LatLng(registry.position.lat, registry.position.lng),
...
google.maps.event.addListener(map, "click", function (event) {
  ...
  submitBtn.addEventListener("click", function () {
    ...
    _api.default.registries.add(registry);
...
var _default = map;
exports.default = _default;
},{"./api":"api.js","./marker":"marker.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
